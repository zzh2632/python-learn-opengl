...
def main():
    ...
    with open("multiplelights.vs", "rb") as file:
        lightingVertexShaderSource = file.read()
    with open("multiplelights.fs", "rb") as file:
    ...
    while not glfw.window_should_close(window):  # 检查一次GLFW是否被要求退出
        ...
        glUniform1f(glGetUniformLocation(lightingShader, "material.shininess"), 64.0)

        # 传入光照信息
        # Directional light
        glUniform3f(glGetUniformLocation(lightingShader, "dirLight.direction"), -0.2, -1.0, -0.3)
        glUniform3f(glGetUniformLocation(lightingShader, "dirLight.ambient"), 0.05, 0.05, 0.05)
        glUniform3f(glGetUniformLocation(lightingShader, "dirLight.diffuse"), 0.4, 0.4, 0.4)
        glUniform3f(glGetUniformLocation(lightingShader, "dirLight.specular"), 0.5, 0.5, 0.5)
        # Point light
        glUniform3fv(glGetUniformLocation(lightingShader, "pointLights[0].position"), 1, value_ptr(pointLightPositions[0]))
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[0].ambient"), 0.05, 0.05, 0.05)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[0].diffuse"), 0.8, 0.8, 0.8)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[0].specular"), 1.0, 1.0, 1.0)
        glUniform1f(glGetUniformLocation(lightingShader, "pointLights[0].constant"), 1.0)
        ...
        glUniform3fv(glGetUniformLocation(lightingShader, "pointLights[1].position"), 1, value_ptr(pointLightPositions[1]))
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[1].ambient"), 0.05, 0.05, 0.05)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[1].diffuse"), 0.8, 0.8, 0.8)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[1].specular"), 1.0, 1.0, 1.0)
        glUniform1f(glGetUniformLocation(lightingShader, "pointLights[1].constant"), 1.0)
        ...
        glUniform3fv(glGetUniformLocation(lightingShader, "pointLights[2].position"), 1, value_ptr(pointLightPositions[2]))
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[2].ambient"), 0.05, 0.05, 0.05)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[2].diffuse"), 0.8, 0.8, 0.8)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[2].specular"), 1.0, 1.0, 1.0)
        glUniform1f(glGetUniformLocation(lightingShader, "pointLights[2].constant"), 1.0)
        ...
        glUniform3fv(glGetUniformLocation(lightingShader, "pointLights[3].position"), 1, value_ptr(pointLightPositions[3]))
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[3].ambient"), 0.05, 0.05, 0.05)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[3].diffuse"), 0.8, 0.8, 0.8)
        glUniform3f(glGetUniformLocation(lightingShader, "pointLights[3].specular"), 1.0, 1.0, 1.0)
        glUniform1f(glGetUniformLocation(lightingShader, "pointLights[3].constant"), 1.0)
